...
class LinearDemo(unittest.TestCase):
    ...
    def test_linear_flow_testing(self):
        ...
        self.assertTrue("Software and QA Testing Company| JigNect Technologies Pvt Ltd" in self.driver.title) # why it knows what the 'title' is if not defined before?
